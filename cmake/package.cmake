...
set(CPACK_PACKAGE_FILE_NAME ${PROJECT_NAME}_${FOONATHAN_MEMORY_VERSION}_${DPKG_ARCH}_${LSB_RELEASE_ID_SHORT})
...
# 描述
set(CPACK_PACKAGE_DESCRIPTION_SUMMARY "package *.deb for easy to use(fast-dds)")

# 供应商信息
set(CPACK_PACKAGE_VENDOR CodePeasant3)
set(CPACK_PACKAGE_CONTACT sunnyhaoming@gmail.com)
